...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BiometricAuthenticationHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/medinazarazuamike@gmail.com/BiometricAuthenticationHelper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'medinazarazuamike@gmail.com' => 'medinazarazuamike@gmail.com' }
  s.source           = { :git => 'https://github.com/medinazarazuamike@gmail.com/BiometricAuthenticationHelper.git', :tag => s.version.to_s }
